...
public class ContextsDbAdapter {
		...
		private static final String DATABASE_TABLE = "contexts";
		private Context context;
		private SQLiteDatabase database;
		private GenericDatabaseHelper dbHelper;

		public ContextsDbAdapter(Context context) {
			this.context = context;
		}

		public ContextsDbAdapter open() throws SQLException {
		...
		public long create(TRContext context) {
			
			ContentValues initialValues = createContentValues(
					context.getId(), 
					context.getName(),
					context.getDescription(), 
					context.getIndexAsString());
		...
		public Cursor fetchAll() {
			return database.query(DATABASE_TABLE, new String[] { KEY_ID, 
					KEY_NAME, KEY_CONTEXTINDEX, KEY_DESCRIPTION}, null, null, null,
					null, null);
		}
